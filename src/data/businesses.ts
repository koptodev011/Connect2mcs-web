...
export const businesses: Business[] = [
  {
    id: "apte-law",
    name: "Apte & Associates",
    owner: "Adv. Suresh Apte",
    cat: "Legal",
    city: "Boston, MA",
    rating: 4.9,
    reviews: 84,
